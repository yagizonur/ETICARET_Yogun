...
$(document).ready(function () {
    ...
    $("CommentBoydId").load("/Comment/ShowProductComments?id=" + productId)
})
...
function doComment(btn, e, commentId, spanId) {
    ...
    if (e == "new_clicked") {
        ...
        if (!mode) {
            ...
            editableContent.offsetParent("editableComment")
            ...
            $.ajax({
                ...
                if (data.result) {
                    $(CommentBodyId).load("/Comment/ShowProdcuctComments?id=" + productId)
                }
                else {
